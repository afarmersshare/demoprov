...
const PERSONAS: PersonaCard[] = [
  ...
  },
  {
    ...
    headline: "Browse the full network, no lens.",
    questions: [
    ...
    <div className="space-y-10">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-[17px] leading-relaxed text-charcoal-soft">
          ...
          Pick a lens — every one lands you in the full explorer; your choice
          only swaps the curated dashboard inside.
        </p>
      </header>
          ...
          return (
            <Link key={p.id} href={href} className="block h-full">
              ...
              >
                ...
                <div className="font-display text-[19px] font-semibold text-charcoal leading-tight mb-3">
                  {p.headline}
                </div>
                <ul className="space-y-1.5 text-sm leading-snug text-charcoal-soft">
                  {p.questions.map((q, i) => (
